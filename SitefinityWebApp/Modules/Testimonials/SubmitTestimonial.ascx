 ...
 <ul class="submit">
     <li>
         ...
         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Name" Text="Required" />
     </li>
     <li>
         ...
         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Summary" Text="Required" />
     </li>
     <li>
         ...
         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Text" Text="Required" />
     </li>
     <li>
